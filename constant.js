        ...
        const skillDescriptions = {
            ...
            "Онлайн и очная оценка кандидатов, проведение интервью, модерация встреч": {
        1: "Проводит первичный обзвон или встречу по готовому скрипту, фиксирует ключевые ответы кандидатов.",
        2: "Уверенно ведёт интервью (онлайн и офлайн), поддерживает деловую атмосферу, знает типовые вопросы для уточнения опыта и мотивации.",
        3: "Использует поведенческие интервью (STAR или аналогичные), ведёт групповые обсуждения (панельное интервью), корректно модерирует диалог.",
        4: "Адаптирует формат интервью под конкретную роль (длительность, кейсы, stress-элементы), учитывает культурные и личностные аспекты общения.",
        5: "Применяет несколько типов оценки (кейсы, ролевые игры, анализ soft-skills), формирует экспертные заключения по итогам беседы.",
        6: "Проводит внутренние обучающие сессии для рекрутеров и менеджеров по эффективному интервью, внедряет чек-листы и структуру вопросов.",
        7: "Разрабатывает комплексные ассесменты (AC), внедряет новые методики интервью (gamification, тестовые площадки), анализирует результативность подходов.",
        8: "Консультирует руководителей высшего звена по корректному отбору для сложных/уникальных вакансий, формирует единые корпоративные стандарты интервью.",
        9: "Привлекает инновационные решения (AI-собеседования, психометрические инструменты), обменивается экспертизой на уровне рынка, формирует передовые практики интервьюирования."
    },
    "Поиск кандидатов и вакансий, определение и анализ ключевых требований и источников поиска, mapping, проработка компаний-доноров": {
        1: "Создаёт простые объявления, получает первые отклики, либо отправляет кандидату базовую информацию.",
        2: "Определяет ключевые источники (job-порталы, соцсети), формирует короткий список кандидатов (shortlist) по базовым критериям.",
        3: "Ведёт самостоятельный поиск (включая ручной сорсинг по конкурентам), понимает структуру компаний-доноров (mapping), формирует план взаимодействия с ними.",
        4: "Анализирует действия конкурентов, строит «карты» (mapping) на фоне всего рынка, выявляет наиболее подходящие компании-доноры и контактирует их сотрудников.",
        5: "Регулярно оценивает конверсию и окупаемость источников, подстраивает стратегию поиска под динамику вакансий, использует KPI (время закрытия, воронка).",
        6: "Проводит активный хантинг (сегментирование кандидатской базы, прямой поиск в соцсетях), настраивает разные форматы взаимодействия (мероприятия, реферальные программы).",
        7: "Руководит воронкой поиска сразу по всем направлениям, внедряет best practices в команду, совершенствует методы анализа рынка и компаний-доноров.",
        8: "Реже занимается ручным поиском, сосредотачивается на оптимизации внутренних процессов и инструментария, чтобы обеспечивать высокую скорость закрытия вакансий.",
        9: "Формирует глобальную экосистему поиска, используя международные базы, AI, стратегические партнёрства; непрерывно внедряет новые технологии и определяет лучшие практики."
    },
    "Обеспечение коммуникации и обратной связи, формирование корректных и грамотных фидбеков (письменно/устно), работа в команде (согласование, HR-системы)": {
        1: "Коротко сообщает кандидату результат интервью, понимает основные принципы взаимодействия с нанимающим менеджером.",
        2: "Структурирует обратную связь (письма/сообщения), учитывает тон HR-бренда, умеет корректно формулировать недостатки кандидатов.",
        3: "Использует командные инструменты (почта, чаты, таск-трекеры) для согласования бюджета, этапов найма; фиксация всей инфо в HR-системах.",
        4: "Обеспечивает единое инфополе: кандидат → менеджер → команда, регулярно обновляет статусы в HR-системах, формирует базовые отчёты для стейкхолдеров.",
        5: "Организует групповые встречи (продуктовые демо, ретро по вакансии), собирает комплексную обратную связь (техническую и soft) и корректирует процесс найма.",
        6: "Формирует культуру открытой коммуникации: вовлекает разных участников (рекомендателей, нанимающих менеджеров) в обсуждение, анализирует эффективность фидбека.",
        7: "Создаёт регламент по обратной связи: как и в какие сроки давать кандидату и менеджеру, обучает команду универсальным скриптам и подходам.",
        8: "Развивает комплексную систему коммуникаций (доступность данных о ходе найма, метрики в HR-дэшбордах), внедряет единые стандарты для оперативного и прозрачного взаимодействия.",
        9: "Масштабирует лучшие практики фидбека на весь холдинг/группу компаний, внедряет инновационные каналы (чат-боты, голосовые ассистенты), поддерживает учёт коммуникаций на уровне Big Data."
    },
    // ... (остальные новые компетенции с аналогичной структурой)
    "Поиск по специализированным платформам, блогам и соцсетям, поиск специалистов на мероприятиях": {
        4: "Использует нишевые ресурсы (GitHub, Stack Overflow, узконаправленные форумы), выявляет потенциальных кандидатов на локальных ивентах (митап, хакатон).",
        5: "Ведёт постоянный мониторинг профильных площадок, организует посещение конференций, фиксирует полезные контакты, анализирует конверсию.",
        6: "Разрабатывает план присутствия на мероприятиях, ведёт общую базу контактов, оценивает ROI каждого канала (мероприятия, форумы, конкурсы).",
        7: "Строит партнёрства с организаторами мероприятий, добивается приоритетного доступа к материалам/спискам участников, ведёт согласованный план поиска через все каналы.",
        8: "Формирует сквозную стратегию поиска в профессиональных сообществах, запускает собственные метапы/конференции, привлекает экспертов со стороны.",
        9: "Глобальный поиск через ведущие отраслевые мероприятия (международные), формирует коллаборации с крупнейшими площадками для охвата редких специалистов."
    },
    "Знание технических и технологических специфик в ИТ и digital направлениях, понимание, для чего они необходимы рекрутерам, навыки технического рекрутинга": {
        3: "Имеет общее представление о популярных технологиях (назначение языков программирования, фреймворков), может отличить фронтенд от бэкенда.",
        4: "Понимает базовые технические требования (стек технологий, версии, окружение), умеет проверять соответствие резюме конкретному набору навыков.",
        5: "Умеет взаимодействовать с техническими экспертами, формирует корректные тестовые задания, может оценить базовые технические ответы.",
        6: "Глубоко разбирается в распространённых технологиях (выбирает подходящие источники поиска, корректно формирует портрет «разработчика Java/DevOps/etc.»).",
        7: "Руководит техническими рекрутерами, формирует единый стандарт скринингов (опросники, тесты), внедряет современные меры оценок (pair-interview, проверка GitHub-портфолио).",
        8: "Успешно закрывает сложные/уникальные IT-позиции (Data Scientist, Cloud Architect и т.д.), формирует стратегию поиска редких спецов, анализируя тренды рынка IT.",
        9: "Разрабатывает новые методики на стыке IT и HR (AI-сопоставление резюме, оптимизация поиска), внедряет их на уровне всей компании, делясь решениями на рынке."
    }
        };
